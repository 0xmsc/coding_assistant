...
- **Fail Early**: Never catch unexpected exceptions silently or just log them; let them bubble up and crash the process if necessary. Crash rather than proceed in an inconsistent state.
