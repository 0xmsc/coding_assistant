...
def test_dense_callbacks_tool_formatting():
    ...
    with patch("coding_assistant.callbacks.print") as mock_print:
        ...
        cb.on_tool_message("TestAgent", "call_1", "mcp_coding_assistant_mcp_shell_execute", {"command": "ls"}, "file1\nfile2")
...
def test_dense_callbacks_state_transition_flushes():
    ...
    for call_args in mock_print.call_args_list:
        for arg in call_args.args:
            if hasattr(arg, "renderable") and hasattr(arg.renderable, "markup") and "Thinking hard" in arg.renderable.markup:
