...
class _CB(ProgressCallbacks):
    def on_user_message(self, context_name, content, force=False): pass
    def on_assistant_message(self, context_name, content, force=False): pass
    def on_assistant_reasoning(self, context_name, content): pass
    def on_tool_start(self, context_name, tool_call_id, tool_name, arguments): pass
    def on_tool_message(self, context_name, tool_call_id, tool_name, arguments, result): pass
    def on_content_chunk(self, chunk): pass
    def on_reasoning_chunk(self, chunk): pass
    def on_chunks_end(self): pass
