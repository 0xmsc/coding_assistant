...
class _CB(ProgressCallbacks):
    ...
    def on_user_message(self, context_name: str, content: str, force: bool = False): pass
    def on_assistant_message(self, context_name: str, content: str, force: bool = False): pass
    def on_assistant_reasoning(self, context_name: str, content: str): self.reasoning.append(content)
    def on_tool_start(self, context_name: str, tool_call_id: str, tool_name: str, arguments: dict): pass
    def on_tool_message(self, context_name: str, tool_call_id: str, tool_name: str, arguments: dict, result: str): pass
