...
from coding_assistant.mcp.skills import create_skills_server, load_builtin_skills, format_skills_instructions, Skill


def get_instructions_with_skills(skills: list[Skill]) -> str:
...
async def _main() -> None:
    ...
    instructions = get_instructions_with_skills(skills)
    ...
    await mcp.import_server(create_skills_server(skills), prefix="skills")
